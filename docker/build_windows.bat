...
REM docker cp 915ff70ebc56:/root/stable-retro/dist/gym_retro-0.9.0-cp311-cp311-win_amd64.whl .
REM pip install retro/dist/gym_retro-0.9.0-cp311-cp311-win_amd64.whl
