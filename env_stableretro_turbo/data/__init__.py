...
from env_stableretro_turbo._retro import GameDataGlue, RetroEmulator
from env_stableretro_turbo._retro import data_path as _data_path
    ...
    for curpath in paths:
        ...
        for j in local_json:
            try:
                ...
                continue
            if (
                scen.get("reward") is not None
                or scen.get("rewards") is not None
                or scen.get("done") is not None
            ):
