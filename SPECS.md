...
- Use `StableRetro-turbo` as the product-facing brand and exact logo text, `env-StableRetro-turbo` as the GitHub repository name, `env-stableretro-turbo` as the Python distribution name, and `env_stableretro_turbo` as the public Python import package.
